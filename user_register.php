...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($stmt->execute()) {
        ...
        try {
            ...
            $mail->SMTPAuth = true;
            $mail->Username = 'ortegaohzenkempt68@gmail.com'; // SMTP username
            $mail->Password = 'rylv qwqg mlgu kcbk'; // SMTP password
            $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
            $mail->Port = 587;

            //Recipients
            $mail->setFrom('ortegaohzenkempt68@gmail.com', 'Mailer');
            $mail->addAddress($email); // Add a recipient

            // Content
            $mail->isHTML(true);
            $mail->Subject = 'Account Verification';
            $mail->Body    = 'Click the link to verify your account: <a href="http://localhost/Ortega_cosep/PRELIM_COSEP/verify.php?code=' . $verification_code . '">Verify Account</a>';
